...
@set M2_HOME=%AD_HOME%\apache-maven\maven-3.0.3
@set M2=%AD_HOME%\apache-maven\maven-3.0.3\bin

@set PATH=%AD_HOME%\apache-maven\maven-3.0.3\bin;%PATH%
...
@set PATH=%PATH%;%AD_HOME%\curl-7.21.1-ssl-sspi-zlib-static-bin-w32;%AD_HOME%\openssl-0.9.8e_WIN32\bin
